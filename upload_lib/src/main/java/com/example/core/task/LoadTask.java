...
import com.example.core.HttpLoadRequest;
import com.example.core.callback.HttpRetryHandler;
import com.example.core.http.LoadRequest;
import com.example.core.http.LoadResponse;
...
public class LoadTask extends BaseTask {
    ...
    public void execute() {
        ...
        // 如果是在多线程中执行，这里的 RetryCount 要保证线程安全
